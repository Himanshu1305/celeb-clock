...
export default function HowToLiveLonger() {
  ...
  const articleSchema = { "@context": "https://schema.org", "@type": "Article", "headline": "How to Live Longer: What Science Actually Says", "description": "The science of longevity in plain language. 7 evidence-based habits that add years to your life — backed by Blue Zone research, Harvard studies, and WHO data.", "author": { "@type": "Organization", "name": "BornClock" }, "publisher": { "@type": "Organization", "name": "BornClock", "logo": { "@type": "ImageObject", "url": "https://bornclock.com/bornclock-logo.png" } }, "datePublished": "2026-06-17", "dateModified": "2026-06-17", "mainEntityOfPage": "https://bornclock.com/answers/how-to-live-longer" };
  const faqSchema = {
