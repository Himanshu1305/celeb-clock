...
import { HindiNumerologyArticle } from '../articles/HindiNumerologyArticle';

afterEach(cleanup);
const renderArticle = () => render(
  <HelmetProvider><MemoryRouter><HindiNumerologyArticle /></MemoryRouter></HelmetProvider>
);

describe('HindiNumerologyArticle', () => {
