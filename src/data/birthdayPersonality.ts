...
export function getDateFact(month: number, day: number): string {
  return DATE_FACTS[`${month}-${day}`] ?? `${MONTH_NAMES[month]} ${day} birthdays belong to a select group of individuals who share your unique zodiac energy and birth day number — a rare combination that shapes your perspective on the world.`;
}
...
const PERSONALITY_PARAGRAPHS: Record<string, Record<number, string>> = {
  Aries: {
    1: 'Those born under Aries with Birth Day Number 1 are the archetypal trailblazers — individuals who not only envision bold new directions but possess the raw drive to pursue them alone. Their energy is kinetic, restless, and magnetic. They rarely wait for permission or consensus; instead, they act first and course-correct as needed. This combination produces leaders who leave permanent marks on whatever field they enter.',
    2: 'Aries energy combined with Birth Day Number 2 creates a rare paradox: a warrior with the soul of a diplomat. These individuals lead with fire but negotiate with finesse, capable of commanding teams while remaining sensitive to each member\'s needs. They win not just through force of will but through genuine connection — a skill most competitors lack.',
    3: 'The Aries-3 combination generates some of the most charismatic personalities in the zodiac. Where pure Aries can be blunt and direct, the Birth Day Number 3 tempers that fire with wit, creative flair, and an extraordinary gift for communication. They don\'t just start things — they inspire others to join them, using story and humor as their most powerful tools.',
    4: 'Aries with Birth Day Number 4 is discipline wearing courage\'s armor. The natural Aries impatience is tempered here by a deep appreciation for craft, systems, and results that last. These individuals build things — companies, movements, institutions — and they build them to endure. They are the generals behind the charge, not just the ones holding the sword.',
  ...
  Taurus: {
    ...
    5: 'Taurus-5 is one of the most interesting combinations in the system — the fixed earth sign meets the explorer\'s birth day number. These individuals carry a constant tension between the desire for security and the pull toward adventure. When they resolve this tension, they create lives of extraordinary richness: stable enough to feel safe, varied enough to feel alive.',
    6: 'Taurus-6 is the born provider and homemaker at their finest. Their Taurus love of stability and beauty combines with the Birth Day Number 6\'s deep calling toward care and service to create individuals who build the most nurturing environments imaginable. Their homes are sanctuaries, their relationships foundations, and their generosity legendary.',
    ...
    8: 'Taurus-8 is a wealth-building machine. Combining Taurus\'s patience and persistence with the Birth Day Number 8\'s material mastery and executive ability, these individuals build financial and material success over time with remarkable consistency. They don\'t chase get-rich-quick schemes; they build slowly, steadily, and with an eye toward lasting value.',
    9: 'Taurus-9 individuals share their abundance with unusual generosity. While their Taurus nature values security and material comfort, their Birth Day Number 9 pushes them toward using those resources in service of the greater good. They are philanthropists at heart — people who build wealth not to hoard it but to deploy it meaningfully.',
  },
  Gemini: {
    ...
    3: 'The Gemini-3 combination is the ultimate creative and expressive personality. Gemini\'s native gift for language meets the Birth Day Number 3\'s calling toward artistic expression to produce individuals of extraordinary wit, charm, and creative output. They make everything they touch more interesting — conversation, writing, comedy, music, performance.',
    4: 'Gemini-4 takes the brilliant, scattered Gemini mind and gives it structure and staying power. Where unmodified Gemini might start ten projects and finish none, the Birth Day Number 4 provides the discipline to see ideas through to completion. These individuals produce intellectual work of extraordinary depth and lasting value.',
  ...
  Cancer: {
    ...
    5: 'Cancer-5 breaks emotional patterns courageously. Where many Cancer natives cling to familiar emotional territory, the Birth Day Number 5 pushes these individuals to explore new relational landscapes, heal inherited family dynamics, and nurture in ways that are fresh and free rather than conditioned or obligatory.',
  ...
  Leo: {
    ...
    2: 'Leo-2 is the warmest combination in the zodiac. Their natural Leo generosity and radiance are deepened by the Birth Day Number 2\'s genuine interest in partnership and cooperation. They light up relationships with unusual grace — giving others the spotlight as often as they claim it themselves, which paradoxically makes them even more beloved.',
    3: 'The Leo-3 combination is pure performing arts genius. Both Leo and Birth Day Number 3 carry enormous creative and expressive energy — together they produce individuals who are naturally entertaining, charismatic, and gifted with an extraordinary ability to move audiences. They don\'t just perform; they transform.',
    4: 'Leo-4 adds backbone to brilliance. Where pure Leo energy can sometimes chase spotlight over substance, the Birth Day Number 4 grounds these individuals in craft, discipline, and a genuine commitment to building something lasting. They have the stage presence to captivate any audience and the work ethic to deserve it.',
  ...
  Virgo: {
    ...
    4: 'Virgo-4 is the master craftsperson at their most dedicated. The already methodical Virgo nature is amplified by the Birth Day Number 4\'s commitment to structure and excellence, producing individuals who achieve genuine mastery in whatever discipline they commit to. They are the professionals others come to when precision and reliability are non-negotiable.',
  ...
  Libra: {
    ...
    2: 'Libra-2 is the natural partner in its most perfect expression. Both Libra and Birth Day Number 2 are fundamentally relational energies — together they create individuals who flourish in deep one-on-one connection and have an almost supernatural ability to create harmony between conflicting parties. They are the mediators, counselors, and partners others need when relationships become difficult.',
    3: 'Libra-3 channels aesthetic genius into creative expression. These individuals have an extraordinary eye for beauty — in design, music, fashion, and the visual arts — combined with the Birth Day Number 3\'s gift for sharing that beauty through creative work. They make the world more beautiful simply by existing in it.',
    4: 'Libra-4 builds fair systems that last. Where Libra can be idealistic about justice, the Birth Day Number 4 adds the practical discipline to actually create lasting institutions, legal frameworks, and organizational structures that embody fairness rather than merely aspiring to it. They are the architects of equity.',
    ...
    8: 'Libra-8 is the powerful negotiator — someone who combines the Libra gift for fairness with the Birth Day Number 8\'s executive authority to create business and legal frameworks that both achieve results and maintain integrity. They are extraordinarily effective in environments where winning requires being right as much as being strong.',
  ...
  Scorpio: {
    ...
    8: 'Scorpio-8 transforms material reality through sheer force of concentrated will. They combine Scorpio\'s penetrating intelligence with the Birth Day Number 8\'s material mastery to create financial and institutional power of unusual magnitude. They are the turnaround artists, the crisis managers, the alchemists of resources.',
  ...
  Capricorn: {
    1: 'Capricorn-1 is the self-made achiever who climbs alone. They combine Capricorn\'s patient ambition with Birth Day Number 1\'s need for independence to create extraordinary careers built entirely on personal merit, original thinking, and relentless effort. They are not natural collaborators, but they don\'t need to be — their solo output is remarkable enough.',
    ...
    3: 'Capricorn-3 communicates authority with unusual grace. They have the executive presence and credibility of the senior Capricorn combined with the Birth Day Number 3\'s gift for accessible, engaging communication. They can make strategy feel inspiring rather than merely logical, which makes them unusually effective leaders and public figures.',
    ...
    8: 'Capricorn-8 is the financial titan — the most natural wealth-builder in the entire system. Capricorn\'s discipline and patience combined with the Birth Day Number 8\'s material mastery and executive authority create individuals who accumulate resources, authority, and legacy with seemingly effortless persistence. They are born for empire.',
  ...
  Aquarius: {
    ...
    4: 'Aquarius-4 builds new structures systematically. Where pure Aquarius can be all vision and no execution, the Birth Day Number 4 provides the methodical discipline to actually design and build the systems of the future. They create the institutions that will outlast current paradigms, the organizational structures that make revolutionary ideas scalable.',
    ...
    8: 'Aquarius-8 turns innovative vision into institutional power. They have the Aquarian capacity to imagine radically better systems and the Birth Day Number 8\'s executive capability to build them at scale. They are the disruptors who don\'t just challenge existing power structures — they replace them with something demonstrably better.',
  ...
  Pisces: {
    1: 'Pisces-1 is the spiritual pioneer who forges entirely original paths through consciousness. They combine the Piscean capacity for mystical perception with the Birth Day Number 1\'s need to act on their individual vision, creating spiritual explorers who don\'t follow traditions but create new ones from direct experience.',
    ...
    4: 'Pisces-4 brings dreams into reality with practical grace. Their Piscean capacity for vision is combined with the Birth Day Number 4\'s ability to build — the result is individuals who create the conditions for their spiritual insights to manifest in the physical world. They are the mystics who get things done.',
...
const NUMEROLOGY_DESCRIPTIONS: Record<number, string> = {
  1: 'Birth Day Number 1 — The Pioneer',
  2: 'Birth Day Number 2 — The Peacemaker',
  3: 'Birth Day Number 3 — The Creative',
  4: 'Birth Day Number 4 — The Builder',
  5: 'Birth Day Number 5 — The Explorer',
  6: 'Birth Day Number 6 — The Nurturer',
  7: 'Birth Day Number 7 — The Seeker',
  8: 'Birth Day Number 8 — The Achiever',
  9: 'Birth Day Number 9 — The Humanitarian',
};

const NUMEROLOGY_DETAIL_PARAGRAPHS: Record<number, string> = {
  1: 'Your Birth Day Number is 1 — the number of the self, the originator, and the individual who initiates change. In Pythagorean numerology, the number 1 carries the energy of the Sun: light, authority, creative force, and the courage to stand apart from the crowd. Those walking Birth Day Number 1 are here to develop independence, originality, and leadership — not as abstract qualities but as lived practices that require constant courage and self-trust. The lesson of the 1 is learning that authentic leadership emerges not from dominating others but from fully becoming yourself.',
  2: 'Your Birth Day Number is 2 — the number of relationship, cooperation, and the profound intelligence that arises between people rather than within individuals alone. In Pythagorean numerology, the number 2 carries the energy of the Moon: receptivity, intuition, and the power of reflection. Those walking Birth Day Number 2 are here to develop the art of partnership, the wisdom of listening, and the strength that comes from genuine collaboration. The lesson of the 2 is discovering that sensitivity is not weakness but one of the most sophisticated forms of intelligence.',
  3: 'Your Birth Day Number is 3 — the number of creative expression, communication, and the joy that flows when inner life finds outer form. In Pythagorean numerology, the number 3 carries the energy of Jupiter: expansion, generosity, and the celebratory quality of existence. Those walking Birth Day Number 3 are here to develop their unique creative voice, share it generously, and inspire others through the beauty and wit of their expression. The lesson of the 3 is learning that authentic joy is itself a gift to the world — that you don\'t need to earn your space through suffering.',
  4: 'Your Birth Day Number is 4 — the number of structure, discipline, and the patient work of building things that matter. In Pythagorean numerology, the number 4 carries the energy of Saturn: form, limitation (as teacher), and the rewards of consistent effort applied over time. Those walking Birth Day Number 4 are here to develop mastery through dedicated practice, create systems that serve others, and demonstrate that lasting achievement is always the product of sustained commitment rather than brilliant shortcuts. The lesson of the 4 is that constraints are often the very conditions that produce excellence.',
  5: 'Your Birth Day Number is 5 — the number of freedom, adventure, and the expansive experience of a life fully lived. In Pythagorean numerology, the number 5 carries the energy of Mercury in motion: quick, curious, adaptable, and perpetually drawn toward the new. Those walking Birth Day Number 5 are here to experience the full range of human possibility, to gather wisdom from diverse encounters, and to model the kind of alive, engaged, curious existence that inspires others to let go of unnecessary limitation. The lesson of the 5 is discovering that true freedom requires occasional roots — that the explorer needs a home to return to.',
  6: 'Your Birth Day Number is 6 — the number of responsibility, care, and the deep fulfillment that comes from genuine service to others. In Pythagorean numerology, the number 6 carries the energy of Venus: beauty, harmony, love, and the healing power of genuine nurturing. Those walking Birth Day Number 6 are here to develop the art of care — for family, community, and the world — while learning that sustainable giving requires self-replenishment. The lesson of the 6 is that taking care of yourself is not selfish but the very foundation of your capacity to take care of others.',
  7: 'Your Birth Day Number is 7 — the number of analysis, spirituality, and the deep pursuit of truth beneath surface appearances. In Pythagorean numerology, the number 7 carries the energy of Neptune: mystery, depth, the unseen, and the profound intelligence that arises from honest inquiry. Those walking Birth Day Number 7 are here to develop genuine wisdom through study, reflection, and the courage to follow questions wherever they lead. The lesson of the 7 is learning that the answers they seek cannot be found in the outer world alone — the deepest truths require inner cultivation.',
  8: 'Your Birth Day Number is 8 — the number of power, material mastery, and the capacity to build institutions and resources that serve large numbers of people. In Pythagorean numerology, the number 8 carries the energy of Saturn at its most executive: authority, accountability, and the understanding that power is not a destination but a responsibility. Those walking Birth Day Number 8 are here to develop genuine competence in the material world, to lead with integrity, and to demonstrate that abundance can be created ethically and shared generously. The lesson of the 8 is that true power serves rather than controls.',
  9: 'Your Birth Day Number is 9 — the number of completion, compassion, and the wisdom that comes from having learned what the previous eight numbers have to teach. In Pythagorean numerology, the number 9 carries the energy of Mars elevated to purpose: the courage of the 1, refined by all subsequent lessons, directed entirely toward collective wellbeing. Those walking Birth Day Number 9 are here to develop universal compassion, release personal attachment to outcomes, and contribute their considerable gifts to the healing of the world. The lesson of the 9 is that true giving means releasing control over what you give — trusting that the good you do will find its way.',
};
...
export function getPersonalityParagraph(sign: string, lifePathNum: number): string {
  return PERSONALITY_PARAGRAPHS[sign]?.[lifePathNum] ??
    `Those born as ${sign} with Birth Day Number ${lifePathNum} combine the elemental energy of ${sign} with the numerological qualities of the ${lifePathNum} — creating a personality of unusual depth, authenticity, and purpose that expresses itself in distinctive and memorable ways.`;
}
...
export function getNumerologyDescription(lifePathNum: number): string {
  return NUMEROLOGY_DESCRIPTIONS[lifePathNum] ?? `Birth Day Number ${lifePathNum}`;
}

export function getNumerologyDetailParagraph(lifePathNum: number): string {
  return NUMEROLOGY_DETAIL_PARAGRAPHS[lifePathNum] ??
    `Your Birth Day Number ${lifePathNum} shapes the underlying purpose and direction of your journey, adding a distinct numerological dimension to the zodiac traits you carry.`;
}
...
export function getLifePathParagraph(lifePathNum: number): string {
  return LIFE_PATH_PARAGRAPHS[lifePathNum] ??
    `Walking Birth Day Number ${lifePathNum}, your core purpose involves the development of specific qualities and contributions that are uniquely yours to offer to the world.`;
}

export function getLifePathChallengeParagraph(lifePathNum: number): string {
  return LIFE_PATH_CHALLENGE_PARAGRAPHS[lifePathNum] ??
    `The growth edge for Birth Day Number ${lifePathNum} involves learning to integrate the shadow side of your natural strengths into a more complete and effective expression of your full potential.`;
}
