...
const STATIC = {
  ...
  '/rising-sign-calculator': { title: 'Rising Sign Calculator — Find Your Ascendant by Birth Time | BornClock', desc: 'Free rising sign (ascendant) calculator by birth date and time. Find your rising sign, the first impression you give, and how it differs from your sun and moon signs.' },
