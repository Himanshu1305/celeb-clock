...
const STATIC = {
  ...
  '/life-expectancy-india':     { title: 'Life Expectancy in India — 2026 Data, Causes & How to Beat the Average', desc: "India's life expectancy is 70.9 years (2023). Here's what drives it, how it compares globally, and what Indian adults can do to outlive the national average." },
  '/life-expectancy-usa':       { title: 'Life Expectancy in the USA — 2026 Data, the Decline & What It Means', desc: "US life expectancy is 77.5 years — but it fell sharply in 2020-21 and hasn't fully recovered. Here's why, and what Americans can do about it." },
  '/life-expectancy-japan':     { title: 'Life Expectancy in Japan — Why Japan Lives Longest & What We Can Learn', desc: "Japan's life expectancy is 84.3 years — the highest of any large nation. The reasons are specific, evidence-based, and partially replicable anywhere." },
  '/life-expectancy-uk':        { title: 'Life Expectancy in the UK — 2026 Data, Regional Gaps & Key Drivers', desc: "UK life expectancy is 81.3 years, but there's a 10-year gap between the healthiest and least healthy regions. Here's what the data shows." },
  '/life-expectancy-australia': { title: 'Life Expectancy in Australia — 2026 Data & Why Australians Live So Long', desc: "Australia's life expectancy is 83.2 years — among the highest in the world. Here's what drives it and where the gaps remain." },
  '/life-expectancy-canada':    { title: 'Life Expectancy in Canada — 2026 Data, Provincial Differences & Key Factors', desc: "Canada's life expectancy is 82.3 years. Here's what drives it, how provinces compare, and why Canada outperforms the USA by nearly 5 years." },
  '/life-expectancy-germany':   { title: 'Life Expectancy in Germany — 2026 Data, East-West Gap & Key Drivers', desc: "Germany's life expectancy is 80.6 years — below most Western European neighbours. Here's why, including the persistent east-west divide." },
  '/life-expectancy-china':     { title: 'Life Expectancy in China — 2026 Data, the Dramatic Rise & Regional Gaps', desc: "China's life expectancy is 78.2 years — up from 43 in 1960. Here's one of history's most dramatic health transformations and what still drives gaps." },
  '/life-expectancy-singapore': { title: "Life Expectancy in Singapore — Why This City-State Ranks Among the World's Best", desc: "Singapore's life expectancy is 83.5 years — one of the highest globally. Here's how a city-state with no natural resources built one of the world's healthiest populations." },
  '/life-expectancy-brazil':    { title: 'Life Expectancy in Brazil — 2026 Data, Inequality & Regional Gaps', desc: "Brazil's life expectancy is 74.6 years. Here's how inequality, violence, and regional gaps shape Brazilian longevity — and what's improving." },
  ...
  '/weight-on-planets':     { title: 'How Much Would You Weigh on Other Planets? — Free Calculator | BornClock', desc: 'Enter your weight and see it on all 8 planets and the Moon — from bouncy Moon gravity to crushing Jupiter — using NASA surface-gravity data. Fun, free, nothing stored.' },
  ...
  '/birthday-report/sample': { title: 'Sample Birthday Intelligence Report — Preview Before You Sign Up | BornClock', desc: 'See a complete Birthday Intelligence Report before creating yours. Preview zodiac, life path, Vedic Rashi, lucky elements, and more.' },
  ...
  '/articles/bryan-johnson-blueprint-alternative': { title: 'Bryan Johnson Blueprint — A Free Science-Backed Alternative | BornClock', desc: 'Bryan Johnson Blueprint costs millions a year. Here is a free, science-backed longevity alternative — the habits that actually matter, no budget needed.' },
